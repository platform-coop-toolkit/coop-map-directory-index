...
from . import views
from .views import INDIVIDUAL_FORMS, ORGANIZATION_FORMS, show_more_about_you_condition, IndividualProfileWizard,\
    OrganizationAutocomplete, OrganizationProfileWizard, PrivacyPolicyView, TermsOfServiceView, AboutPageView
...
urlpatterns = [
    ...
    path('profiles/organization', OrganizationProfileWizard.as_view(ORGANIZATION_FORMS, instance_dict={'social_networks': UserSocialNetwork}), name='organization-profile'),
