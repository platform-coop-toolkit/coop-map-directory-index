...
from . import views
from .views import INDIVIDUAL_FORMS, ORGANIZATION_FORMS, IndividualProfileWizard, OrganizationAutocomplete,\
    OrganizationProfileWizard, PrivacyPolicyView, TermsOfServiceView, AboutPageView
...
urlpatterns = [
    ...
    path('profiles/organization', OrganizationProfileWizard.as_view(ORGANIZATION_FORMS), {'title': 'Organization'}, name='organization-profile'),
